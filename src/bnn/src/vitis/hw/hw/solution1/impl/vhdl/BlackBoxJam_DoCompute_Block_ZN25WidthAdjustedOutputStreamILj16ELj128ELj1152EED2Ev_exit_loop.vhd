...
entity BlackBoxJam_DoCompute_Block_ZN25WidthAdjustedOutputStreamILj16ELj128ELj1152EED2Ev_exit_loop is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of BlackBoxJam_DoCompute_Block_ZN25WidthAdjustedOutputStreamILj16ELj128ELj1152EED2Ev_exit_loop is 
...
attribute shreg_extract : string;
    ...
    signal trunc_ln265_fu_20_p1 : STD_LOGIC_VECTOR (22 downto 0);
    signal tmp_fu_24_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal totalIters_fu_32_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal totalIters_1_fu_40_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                                        ap_return_0_preg(31 downto 6) <= totalIters_1_fu_40_p2(31 downto 6);
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                                        ap_return_1_preg(31 downto 6) <= totalIters_fu_32_p3(31 downto 6);
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                                        ap_return_2_preg(31 downto 9) <= tmp_fu_24_p3(31 downto 9);
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_return_0_assign_proc : process(ap_CS_fsm_state1, ap_block_state1, totalIters_1_fu_40_p2, ap_return_0_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_0 <= totalIters_1_fu_40_p2;
        else 
    ...
    ap_return_1_assign_proc : process(ap_CS_fsm_state1, ap_block_state1, totalIters_fu_32_p3, ap_return_1_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_1 <= totalIters_fu_32_p3;
        else 
    ...
    ap_return_2_assign_proc : process(ap_CS_fsm_state1, ap_block_state1, tmp_fu_24_p3, ap_return_2_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_2 <= tmp_fu_24_p3;
        else 
            ap_return_2 <= ap_return_2_preg;
        end if; 
    end process;

    tmp_fu_24_p3 <= (trunc_ln265_fu_20_p1 & ap_const_lv9_0);
    totalIters_1_fu_40_p2 <= std_logic_vector(unsigned(tmp_fu_24_p3) + unsigned(totalIters_fu_32_p3));
    totalIters_fu_32_p3 <= (numReps & ap_const_lv6_0);
    trunc_ln265_fu_20_p1 <= numReps(23 - 1 downto 0);
end behav;
