...
module BlackBoxJam_DoCompute_Block_ZN25WidthAdjustedOutputStreamILj16ELj128ELj1152EED2Ev_exit_loop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_block_state1;
wire   [22:0] trunc_ln265_fu_20_p1;
wire   [31:0] tmp_fu_24_p3;
wire   [31:0] totalIters_fu_32_p3;
wire   [31:0] totalIters_1_fu_40_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
                        ap_return_0_preg[31 : 6] <= totalIters_1_fu_40_p2[31 : 6];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
                        ap_return_1_preg[31 : 6] <= totalIters_fu_32_p3[31 : 6];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
                        ap_return_2_preg[31 : 9] <= tmp_fu_24_p3[31 : 9];
        end
    end
end
...
assign tmp_fu_24_p3 = {{trunc_ln265_fu_20_p1}, {9'd0}};

assign totalIters_1_fu_40_p2 = (tmp_fu_24_p3 + totalIters_fu_32_p3);

assign totalIters_fu_32_p3 = {{numReps}, {6'd0}};

assign trunc_ln265_fu_20_p1 = numReps[22:0];
...
endmodule //BlackBoxJam_DoCompute_Block_ZN25WidthAdjustedOutputStreamILj16ELj128ELj1152EED2Ev_exit_loop
