...
entity BlackBoxJam_DoCompute_Block_ZN24WidthAdjustedInputStreamILj64ELj32ELj196EEC2ERN3hls6streamI is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of BlackBoxJam_DoCompute_Block_ZN24WidthAdjustedInputStreamILj64ELj32ELj196EEC2ERN3hls6streamI is 
...
attribute shreg_extract : string;
    ...
    signal trunc_ln121_fu_30_p1 : STD_LOGIC_VECTOR (20 downto 0);
    signal trunc_ln121_1_fu_42_p1 : STD_LOGIC_VECTOR (23 downto 0);
    signal trunc_ln_i_fu_34_p3 : STD_LOGIC_VECTOR (27 downto 0);
    signal shl_ln121_1_i_fu_46_p3 : STD_LOGIC_VECTOR (27 downto 0);
    signal tmp_fu_22_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln121_fu_54_p2 : STD_LOGIC_VECTOR (27 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                                        ap_return_0_preg(31 downto 7) <= tmp_fu_22_p3(31 downto 7);
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                                        ap_return_1_preg(27 downto 4) <= add_ln121_fu_54_p2(27 downto 4);
                end if; 
            end if;
        end if;
    end process;

    ap_return_0_preg(6 downto 0) <= "0000000";
    ...
    add_ln121_fu_54_p2 <= std_logic_vector(unsigned(trunc_ln_i_fu_34_p3) + unsigned(shl_ln121_1_i_fu_46_p3));
    ...
    ap_return_0_assign_proc : process(ap_CS_fsm_state1, ap_block_state1, tmp_fu_22_p3, ap_return_0_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    ap_return_1_assign_proc : process(ap_CS_fsm_state1, ap_block_state1, add_ln121_fu_54_p2, ap_return_1_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    shl_ln121_1_i_fu_46_p3 <= (trunc_ln121_1_fu_42_p1 & ap_const_lv4_0);
    tmp_fu_22_p3 <= (numReps & ap_const_lv7_0);
    trunc_ln121_1_fu_42_p1 <= numReps(24 - 1 downto 0);
    trunc_ln121_fu_30_p1 <= numReps(21 - 1 downto 0);
    trunc_ln_i_fu_34_p3 <= (trunc_ln121_fu_30_p1 & ap_const_lv7_0);
end behav;
