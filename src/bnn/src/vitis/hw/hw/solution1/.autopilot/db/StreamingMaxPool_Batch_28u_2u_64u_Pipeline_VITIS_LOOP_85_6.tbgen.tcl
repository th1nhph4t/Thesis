set moduleName StreamingMaxPool_Batch_28u_2u_64u_Pipeline_VITIS_LOOP_85_6
set isTopModule 0
...
set C_modelName {StreamingMaxPool_Batch<28u, 2u, 64u>_Pipeline_VITIS_LOOP_85_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ buf_r int 64 regular {array 14 { 2 3 } 1 1 }  }
...
set portList { 
	...
	{ buf_r_d0 sc_out sc_lv 64 signal 0 } 
	{ buf_r_q0 sc_in sc_lv 64 signal 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buf_r_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "buf_r", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	buf_r { ap_memory {  { buf_r_address0 mem_address 1 4 }  { buf_r_ce0 mem_ce 1 1 }  { buf_r_we0 mem_we 1 1 }  { buf_r_d0 mem_din 1 64 }  { buf_r_q0 in_data 0 64 } } }
