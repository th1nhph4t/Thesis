set moduleName StreamingMaxPool_Batch_10u_2u_128u_Pipeline_VITIS_LOOP_85_6
set isTopModule 0
...
set C_modelName {StreamingMaxPool_Batch<10u, 2u, 128u>_Pipeline_VITIS_LOOP_85_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ buf_r int 128 regular {array 5 { 2 3 } 1 1 }  }
...
set portList { 
	...
	{ buf_r_address0 sc_out sc_lv 3 signal 0 } 
	{ buf_r_ce0 sc_out sc_logic 1 signal 0 } 
	{ buf_r_we0 sc_out sc_logic 1 signal 0 } 
	{ buf_r_d0 sc_out sc_lv 128 signal 0 } 
	{ buf_r_q0 sc_in sc_lv 128 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	buf_r { ap_memory {  { buf_r_address0 mem_address 1 3 }  { buf_r_ce0 mem_ce 1 1 }  { buf_r_we0 mem_we 1 1 }  { buf_r_d0 mem_din 1 128 }  { buf_r_q0 in_data 0 128 } } }
