set moduleName StreamingDataWidthConverter_Batch_64u_192u_384u_s
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "inter0", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "numReps_c159", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ inter0_dout sc_in sc_lv 64 signal 0 } 
	{ inter0_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ inter0_fifo_cap sc_in sc_lv 3 signal 0 } 
	{ inter0_empty_n sc_in sc_logic 1 signal 0 } 
	{ inter0_read sc_out sc_logic 1 signal 0 } 
	{ inter0_1_din sc_out sc_lv 192 signal 1 } 
	{ inter0_1_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ inter0_1_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ inter0_1_full_n sc_in sc_logic 1 signal 1 } 
	{ inter0_1_write sc_out sc_logic 1 signal 1 } 
	...
	{ numReps_c159_din sc_out sc_lv 32 signal 3 } 
	{ numReps_c159_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ numReps_c159_fifo_cap sc_in sc_lv 3 signal 3 } 
	{ numReps_c159_full_n sc_in sc_logic 1 signal 3 } 
	{ numReps_c159_write sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "numReps_c159_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "numReps_c159", "role": "din" }} , 
 	{ "name": "numReps_c159_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "numReps_c159", "role": "num_data_valid" }} , 
 	{ "name": "numReps_c159_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "numReps_c159", "role": "fifo_cap" }} , 
 	{ "name": "numReps_c159_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "numReps_c159", "role": "full_n" }} , 
 	{ "name": "numReps_c159_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "numReps_c159", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "inter0", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_StreamingDataWidthConverter_Batch_64u_192u_384u_Pipeline_VITIS_LOOP_300_3_fu_54", "Port" : "inter0", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "inter0_1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_StreamingDataWidthConverter_Batch_64u_192u_384u_Pipeline_VITIS_LOOP_300_3_fu_54", "Port" : "inter0_1", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "numReps_c159", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "numReps_c159_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_StreamingDataWidthConverter_Batch_64u_192u_384u_Pipeline_VITIS_LOOP_300_3_fu_54", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_StreamingDataWidthConverter_Batch_64u_192u_384u_Pipeline_VITIS_LOOP_300_3_fu_54.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	numReps_c159 { ap_fifo {  { numReps_c159_din fifo_data_in 1 32 }  { numReps_c159_num_data_valid fifo_status_num_data_valid 0 3 }  { numReps_c159_fifo_cap fifo_update 0 3 }  { numReps_c159_full_n fifo_status 0 1 }  { numReps_c159_write fifo_port_we 1 1 } } }
}
