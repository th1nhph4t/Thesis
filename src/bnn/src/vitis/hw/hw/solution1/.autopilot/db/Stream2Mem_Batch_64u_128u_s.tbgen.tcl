set moduleName Stream2Mem_Batch_64u_128u_s
set isTopModule 0
...
set C_modelName {Stream2Mem_Batch<64u, 128u>}
...
set portList { 
	...
	{ memOutStrm34_dout sc_in sc_lv 64 signal 0 } 
	{ memOutStrm34_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ memOutStrm34_fifo_cap sc_in sc_lv 3 signal 0 } 
	{ memOutStrm34_empty_n sc_in sc_logic 1 signal 0 } 
	{ memOutStrm34_read sc_out sc_logic 1 signal 0 } 
	{ m_axi_hostmem_AWVALID sc_out sc_logic 1 signal 1 } 
	{ m_axi_hostmem_AWREADY sc_in sc_logic 1 signal 1 } 
	{ m_axi_hostmem_AWADDR sc_out sc_lv 64 signal 1 } 
	{ m_axi_hostmem_AWID sc_out sc_lv 1 signal 1 } 
	{ m_axi_hostmem_AWLEN sc_out sc_lv 32 signal 1 } 
	{ m_axi_hostmem_AWSIZE sc_out sc_lv 3 signal 1 } 
	{ m_axi_hostmem_AWBURST sc_out sc_lv 2 signal 1 } 
	{ m_axi_hostmem_AWLOCK sc_out sc_lv 2 signal 1 } 
	{ m_axi_hostmem_AWCACHE sc_out sc_lv 4 signal 1 } 
	{ m_axi_hostmem_AWPROT sc_out sc_lv 3 signal 1 } 
	{ m_axi_hostmem_AWQOS sc_out sc_lv 4 signal 1 } 
	{ m_axi_hostmem_AWREGION sc_out sc_lv 4 signal 1 } 
	{ m_axi_hostmem_AWUSER sc_out sc_lv 1 signal 1 } 
	{ m_axi_hostmem_WVALID sc_out sc_logic 1 signal 1 } 
	{ m_axi_hostmem_WREADY sc_in sc_logic 1 signal 1 } 
	{ m_axi_hostmem_WDATA sc_out sc_lv 64 signal 1 } 
	{ m_axi_hostmem_WSTRB sc_out sc_lv 8 signal 1 } 
	{ m_axi_hostmem_WLAST sc_out sc_logic 1 signal 1 } 
	{ m_axi_hostmem_WID sc_out sc_lv 1 signal 1 } 
	{ m_axi_hostmem_WUSER sc_out sc_lv 1 signal 1 } 
	{ m_axi_hostmem_ARVALID sc_out sc_logic 1 signal 1 } 
	{ m_axi_hostmem_ARREADY sc_in sc_logic 1 signal 1 } 
	{ m_axi_hostmem_ARADDR sc_out sc_lv 64 signal 1 } 
	{ m_axi_hostmem_ARID sc_out sc_lv 1 signal 1 } 
	{ m_axi_hostmem_ARLEN sc_out sc_lv 32 signal 1 } 
	{ m_axi_hostmem_ARSIZE sc_out sc_lv 3 signal 1 } 
	{ m_axi_hostmem_ARBURST sc_out sc_lv 2 signal 1 } 
	{ m_axi_hostmem_ARLOCK sc_out sc_lv 2 signal 1 } 
	{ m_axi_hostmem_ARCACHE sc_out sc_lv 4 signal 1 } 
	{ m_axi_hostmem_ARPROT sc_out sc_lv 3 signal 1 } 
	{ m_axi_hostmem_ARQOS sc_out sc_lv 4 signal 1 } 
	{ m_axi_hostmem_ARREGION sc_out sc_lv 4 signal 1 } 
	{ m_axi_hostmem_ARUSER sc_out sc_lv 1 signal 1 } 
	{ m_axi_hostmem_RVALID sc_in sc_logic 1 signal 1 } 
	{ m_axi_hostmem_RREADY sc_out sc_logic 1 signal 1 } 
	{ m_axi_hostmem_RDATA sc_in sc_lv 64 signal 1 } 
	{ m_axi_hostmem_RLAST sc_in sc_logic 1 signal 1 } 
	{ m_axi_hostmem_RID sc_in sc_lv 1 signal 1 } 
	{ m_axi_hostmem_RFIFONUM sc_in sc_lv 9 signal 1 } 
	{ m_axi_hostmem_RUSER sc_in sc_lv 1 signal 1 } 
	{ m_axi_hostmem_RRESP sc_in sc_lv 2 signal 1 } 
	{ m_axi_hostmem_BVALID sc_in sc_logic 1 signal 1 } 
	{ m_axi_hostmem_BREADY sc_out sc_logic 1 signal 1 } 
	{ m_axi_hostmem_BRESP sc_in sc_lv 2 signal 1 } 
	{ m_axi_hostmem_BID sc_in sc_lv 1 signal 1 } 
	{ m_axi_hostmem_BUSER sc_in sc_lv 1 signal 1 } 
	...
	{ numReps_dout sc_in sc_lv 32 signal 3 } 
	{ numReps_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ numReps_fifo_cap sc_in sc_lv 3 signal 3 } 
	{ numReps_empty_n sc_in sc_logic 1 signal 3 } 
	{ numReps_read sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "memOutStrm34", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Stream2Mem_Batch_64u_128u_Pipeline_VITIS_LOOP_153_15_fu_93", "Port" : "memOutStrm34", "Inst_start_state" : "4", "Inst_end_state" : "5"},
					{"ID" : "3", "SubInstance" : "grp_Stream2Mem_Batch_64u_128u_Pipeline_VITIS_LOOP_153_1_fu_102", "Port" : "memOutStrm34", "Inst_start_state" : "11", "Inst_end_state" : "12"}]},
			{"Name" : "hostmem", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "hostmem_blk_n_AW", "Type" : "RtlSignal"},
					{"Name" : "hostmem_blk_n_B", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Stream2Mem_Batch_64u_128u_Pipeline_VITIS_LOOP_153_15_fu_93", "Port" : "hostmem", "Inst_start_state" : "4", "Inst_end_state" : "5"},
					{"ID" : "3", "SubInstance" : "grp_Stream2Mem_Batch_64u_128u_Pipeline_VITIS_LOOP_153_1_fu_102", "Port" : "hostmem", "Inst_start_state" : "11", "Inst_end_state" : "12"}]},
			{"Name" : "out_r", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "38", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Stream2Mem_Batch_64u_128u_Pipeline_VITIS_LOOP_153_15_fu_93", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Stream2Mem_Batch_64u_128u_Pipeline_VITIS_LOOP_153_15_fu_93.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Stream2Mem_Batch_64u_128u_Pipeline_VITIS_LOOP_153_1_fu_102", "Parent" : "0", "Child" : ["4"],
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_153_1", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter2", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter2", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Stream2Mem_Batch_64u_128u_Pipeline_VITIS_LOOP_153_1_fu_102.flow_control_loop_pipe_sequential_init_U", "Parent" : "3"}]}
...
set Spec2ImplPortList { 
	...
	out_r { ap_fifo {  { out_r_dout fifo_data_in 0 64 }  { out_r_num_data_valid fifo_status_num_data_valid 0 7 }  { out_r_fifo_cap fifo_update 0 7 }  { out_r_empty_n fifo_status 0 1 }  { out_r_read fifo_port_we 1 1 } } }
