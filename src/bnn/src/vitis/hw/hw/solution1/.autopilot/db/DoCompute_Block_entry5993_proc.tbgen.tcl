set moduleName DoCompute_Block_entry5993_proc
set isTopModule 0
...
set C_modelName {DoCompute_Block_entry5993_proc}
set C_modelType { int 60 }
set C_modelArgList {
	{ numReps int 30 regular  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "numReps", "interface" : "wire", "bitwidth" : 30, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ numReps sc_in sc_lv 30 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "numReps", "direction": "in", "datatype": "sc_lv", "bitwidth":30, "type": "signal", "bundle":{"name": "numReps", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_30s_11ns_30_2_1_U38", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	numReps { ap_none {  { numReps in_data 0 30 } } }
}
