set moduleName Mem2Stream_Batch_64u_3072u_s
set isTopModule 0
...
set C_modelName {Mem2Stream_Batch<64u, 3072u>}
set C_modelType { void 0 }
set C_modelArgList {
	{ hostmem int 64 regular {axi_master 0}  }
	{ in_r int 64 regular  }
	{ inter0 int 64 regular {fifo 1 volatile }  }
	{ numReps int 32 regular  }
	{ numReps_c160 int 32 regular {fifo 1}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "hostmem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in_r","offset": { "type": "dynamic","port_name": "in_r","bundle": "control"},"direction": "READONLY"},{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "in_r", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "inter0", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "numReps", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "numReps_c160", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ inter0_din sc_out sc_lv 64 signal 2 } 
	{ inter0_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ inter0_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ inter0_full_n sc_in sc_logic 1 signal 2 } 
	{ inter0_write sc_out sc_logic 1 signal 2 } 
	{ numReps sc_in sc_lv 32 signal 3 } 
	{ numReps_c160_din sc_out sc_lv 32 signal 4 } 
	{ numReps_c160_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ numReps_c160_fifo_cap sc_in sc_lv 3 signal 4 } 
	{ numReps_c160_full_n sc_in sc_logic 1 signal 4 } 
	{ numReps_c160_write sc_out sc_logic 1 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "inter0_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "inter0", "role": "din" }} , 
 	...
 	{ "name": "inter0_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "inter0", "role": "full_n" }} , 
 	{ "name": "inter0_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "inter0", "role": "write" }} , 
 	{ "name": "numReps", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "numReps", "role": "default" }} , 
 	{ "name": "numReps_c160_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "numReps_c160", "role": "din" }} , 
 	{ "name": "numReps_c160_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "numReps_c160", "role": "num_data_valid" }} , 
 	{ "name": "numReps_c160_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "numReps_c160", "role": "fifo_cap" }} , 
 	{ "name": "numReps_c160_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "numReps_c160", "role": "full_n" }} , 
 	{ "name": "numReps_c160_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "numReps_c160", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3"],
		...
		"Port" : [
			{"Name" : "hostmem", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_Mem2Stream_Batch_64u_3072u_Pipeline_VITIS_LOOP_140_1_fu_117", "Port" : "hostmem", "Inst_start_state" : "20", "Inst_end_state" : "12"},
					{"ID" : "1", "SubInstance" : "grp_Mem2Stream_Batch_64u_3072u_Pipeline_VITIS_LOOP_140_16_fu_108", "Port" : "hostmem", "Inst_start_state" : "11", "Inst_end_state" : "12"}]},
			{"Name" : "in_r", "Type" : "None", "Direction" : "I"},
			{"Name" : "inter0", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_Mem2Stream_Batch_64u_3072u_Pipeline_VITIS_LOOP_140_1_fu_117", "Port" : "inter0", "Inst_start_state" : "20", "Inst_end_state" : "12"},
					{"ID" : "1", "SubInstance" : "grp_Mem2Stream_Batch_64u_3072u_Pipeline_VITIS_LOOP_140_16_fu_108", "Port" : "inter0", "Inst_start_state" : "11", "Inst_end_state" : "12"}]},
			{"Name" : "numReps", "Type" : "None", "Direction" : "I"},
			{"Name" : "numReps_c160", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Mem2Stream_Batch_64u_3072u_Pipeline_VITIS_LOOP_140_16_fu_108", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mem2Stream_Batch_64u_3072u_Pipeline_VITIS_LOOP_140_16_fu_108.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Mem2Stream_Batch_64u_3072u_Pipeline_VITIS_LOOP_140_1_fu_117", "Parent" : "0", "Child" : ["4"],
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_140_1", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter2", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter2", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mem2Stream_Batch_64u_3072u_Pipeline_VITIS_LOOP_140_1_fu_117.flow_control_loop_pipe_sequential_init_U", "Parent" : "3"}]}
...
set Spec2ImplPortList { 
	...
	inter0 { ap_fifo {  { inter0_din fifo_data_in 1 64 }  { inter0_num_data_valid fifo_status_num_data_valid 0 3 }  { inter0_fifo_cap fifo_update 0 3 }  { inter0_full_n fifo_status 0 1 }  { inter0_write fifo_port_we 1 1 } } }
	numReps { ap_none {  { numReps in_data 0 32 } } }
	numReps_c160 { ap_fifo {  { numReps_c160_din fifo_data_in 1 32 }  { numReps_c160_num_data_valid fifo_status_num_data_valid 0 3 }  { numReps_c160_fifo_cap fifo_update 0 3 }  { numReps_c160_full_n fifo_status 0 1 }  { numReps_c160_write fifo_port_we 1 1 } } }
}
