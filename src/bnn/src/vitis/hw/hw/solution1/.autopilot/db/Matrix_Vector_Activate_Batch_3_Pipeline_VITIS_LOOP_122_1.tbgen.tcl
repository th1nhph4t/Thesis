set moduleName Matrix_Vector_Activate_Batch_3_Pipeline_VITIS_LOOP_122_1
set isTopModule 0
...
set C_modelName {Matrix_Vector_Activate_Batch.3_Pipeline_VITIS_LOOP_122_1}
...
set portList { 
	...
	{ wa_in_1_dout sc_in sc_lv 8 signal 1 } 
	{ wa_in_1_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ wa_in_1_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ wa_in_1_empty_n sc_in sc_logic 1 signal 1 } 
	{ wa_in_1_read sc_out sc_logic 1 signal 1 } 
	{ wa_out_m_buffer_din sc_out sc_lv 1 signal 2 } 
	{ wa_out_m_buffer_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ wa_out_m_buffer_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ wa_out_m_buffer_full_n sc_in sc_logic 1 signal 2 } 
	{ wa_out_m_buffer_write sc_out sc_logic 1 signal 2 } 
	{ empty sc_in sc_lv 32 signal 0 } 
	{ weights7_address0 sc_out sc_lv 15 signal 3 } 
	{ weights7_ce0 sc_out sc_logic 1 signal 3 } 
	{ weights7_q0 sc_in sc_lv 8 signal 3 } 
	{ threshs7_address0 sc_out sc_lv 9 signal 4 } 
	{ threshs7_ce0 sc_out sc_logic 1 signal 4 } 
	{ threshs7_q0 sc_in sc_lv 16 signal 4 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_129_6_8_1_1_U621", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	weights7 { ap_memory {  { weights7_address0 mem_address 1 15 }  { weights7_ce0 mem_ce 1 1 }  { weights7_q0 in_data 0 8 } } }
