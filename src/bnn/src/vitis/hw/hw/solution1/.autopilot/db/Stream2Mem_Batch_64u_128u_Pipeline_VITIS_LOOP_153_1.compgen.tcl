...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_memOutStrm34 \
    op interface \
    ports { memOutStrm34_dout { I 64 vector } memOutStrm34_num_data_valid { I 3 vector } memOutStrm34_fifo_cap { I 3 vector } memOutStrm34_empty_n { I 1 bit } memOutStrm34_read { O 1 bit } } \
} "
}
