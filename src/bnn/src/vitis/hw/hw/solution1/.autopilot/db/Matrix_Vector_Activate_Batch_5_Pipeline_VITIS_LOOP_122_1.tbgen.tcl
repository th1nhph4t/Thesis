set moduleName Matrix_Vector_Activate_Batch_5_Pipeline_VITIS_LOOP_122_1
set isTopModule 0
...
set C_modelName {Matrix_Vector_Activate_Batch.5_Pipeline_VITIS_LOOP_122_1}
...
set portList { 
	...
	{ wa_in_2_dout sc_in sc_lv 4 signal 1 } 
	{ wa_in_2_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ wa_in_2_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ wa_in_2_empty_n sc_in sc_logic 1 signal 1 } 
	{ wa_in_2_read sc_out sc_logic 1 signal 1 } 
	{ wa_out_m_buffer_2_din sc_out sc_lv 1 signal 2 } 
	{ wa_out_m_buffer_2_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ wa_out_m_buffer_2_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ wa_out_m_buffer_2_full_n sc_in sc_logic 1 signal 2 } 
	{ wa_out_m_buffer_2_write sc_out sc_logic 1 signal 2 } 
	{ empty sc_in sc_lv 32 signal 0 } 
	{ weights6_address0 sc_out sc_lv 15 signal 3 } 
	{ weights6_ce0 sc_out sc_logic 1 signal 3 } 
	{ weights6_q0 sc_in sc_lv 4 signal 3 } 
	{ threshs6_address0 sc_out sc_lv 9 signal 4 } 
	{ threshs6_ce0 sc_out sc_logic 1 signal 4 } 
	{ threshs6_q0 sc_in sc_lv 16 signal 4 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_129_6_4_1_1_U595", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	weights6 { ap_memory {  { weights6_address0 mem_address 1 15 }  { weights6_ce0 mem_ce 1 1 }  { weights6_q0 in_data 0 4 } } }
	threshs6 { ap_memory {  { threshs6_address0 mem_address 1 9 }  { threshs6_ce0 mem_ce 1 1 }  { threshs6_q0 in_data 0 16 } } }
}
