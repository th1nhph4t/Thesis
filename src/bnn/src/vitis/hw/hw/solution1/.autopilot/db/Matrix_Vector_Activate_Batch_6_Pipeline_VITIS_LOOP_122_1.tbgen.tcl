set moduleName Matrix_Vector_Activate_Batch_6_Pipeline_VITIS_LOOP_122_1
set isTopModule 0
...
set C_modelName {Matrix_Vector_Activate_Batch.6_Pipeline_VITIS_LOOP_122_1}
...
set portList { 
	...
	{ convInp_dout sc_in sc_lv 32 signal 1 } 
	{ convInp_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ convInp_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ convInp_empty_n sc_in sc_logic 1 signal 1 } 
	{ convInp_read sc_out sc_logic 1 signal 1 } 
	{ mvOut_m_buffer_din sc_out sc_lv 1 signal 2 } 
	{ mvOut_m_buffer_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ mvOut_m_buffer_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ mvOut_m_buffer_full_n sc_in sc_logic 1 signal 2 } 
	{ mvOut_m_buffer_write sc_out sc_logic 1 signal 2 } 
	{ mul_i sc_in sc_lv 32 signal 0 } 
	{ weights5_address0 sc_out sc_lv 15 signal 3 } 
	{ weights5_ce0 sc_out sc_logic 1 signal 3 } 
	{ weights5_q0 sc_in sc_lv 32 signal 3 } 
	{ threshs5_address0 sc_out sc_lv 8 signal 4 } 
	{ threshs5_ce0 sc_out sc_logic 1 signal 4 } 
	{ threshs5_q0 sc_in sc_lv 16 signal 4 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_145_7_32_1_1_U568", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	weights5 { ap_memory {  { weights5_address0 mem_address 1 15 }  { weights5_ce0 mem_ce 1 1 }  { weights5_q0 in_data 0 32 } } }
	threshs5 { ap_memory {  { threshs5_address0 mem_address 1 8 }  { threshs5_ce0 mem_ce 1 1 }  { threshs5_q0 in_data 0 16 } } }
}
